...
In early October, I finally graduated with an AI/ML degree from the University of [Nice Côte d'Azur](https://univ-cotedazur.fr/). Since all the hype is around language models, I thought it would be fun to write a story about my graduation blog post using the [ChatGPT](https://openai.com/blog/chatgpt/) model.
